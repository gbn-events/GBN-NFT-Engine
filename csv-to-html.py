        ...
        for row in csv_reader:
            ...
            if not os.path.exists(output_html_file_path):
                with open(output_html_file_path, "w") as html_file:
                    ...
                    template = template.replace("XXXXXXexternal_urlXXXXXX", row[5])                    
                    ...
                    template = template.replace("XXXXXXcountryXXXXXX", row[11])
                    template = template.replace("XXXXXXrarityXXXXXX", row[12])
                    template = template.replace("XXXXXXcard_group_lookupXXXXXX", row[13])
                    template = template.replace("XXXXXXcreated_dateXXXXXX", row[14])
                    template = template.replace("XXXXXXhuman_impactXXXXXX", row[15])
                    template = template.replace("XXXXXXgeocordsXXXXXX", row[16])
                    template = template.replace("XXXXXXevent_idXXXXXX", row[17])
                    template = template.replace("XXXXXXcolor_rarity_hexXXXXXX", row[18])
                    template = template.replace("XXXXXXcolor_bkgd_hexXXXXXX", row[19])
                    template = template.replace("XXXXXXcolor_card_hexXXXXXX", row[20])
                    template = template.replace("XXXXXXblog_postXXXXXX", row[21])
                    template = template.replace("XXXXXXlocation_nameXXXXXX", row[22])
                    template = template.replace("XXXXXXmapXXXXXX", row[23])
                    template = template.replace("XXXXXXtravel_pointsXXXXXX", row[24])
                    template = template.replace("XXXXXXyoutube_urlXXXXXX", row[25])
                    template = template.replace("XXXXXXimage_htmlXXXXXX", row[26])
                    template = template.replace("XXXXXXanimation_htmlXXXXXX", row[27])
                    template = template.replace("XXXXXXspecial_image_htmlXXXXXX", row[28])
                    template = template.replace("XXXXXXtoken_quantityXXXXXX", row[29])
                    template = template.replace("XXXXXXprice_in_usdXXXXXX", row[30])
                    template = template.replace("XXXXXXprice_in_ethXXXXXX", row[31])
